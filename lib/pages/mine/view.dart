                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Stack(
                              children: [
                                logic.userHead==null? Container():(logic.userHead=="" || logic.userHead=="null"? Container():
                                Positioned(
                                  left: 25.w,
                                  top: 120.h,
                                  child: Container(
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () async {
                              ...
                              var ss =  await StorageService.to.getString("openid");
                              if(ss == ""){
                                logic.bindWxOnTap();
                              }else{
                                _bindWx(context,"");
...
class TopCard extends StatelessWidget {
  TopCard({required this.url, required this.title,  this.onPressed, required this.content, required this.colorStart, required this.colorEnd});
