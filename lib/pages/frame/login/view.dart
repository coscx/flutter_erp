...
class LoginPage extends StatelessWidget {
            ...
            children: <Widget>[
              ...
              Stack(
                ...
                children: [
                  buildPasswordInput(),
                  GestureDetector(
                      onTap: () => (() => logic.showPwd = !logic.showPwd),
                      child: Icon(
                          logic.showPwd ? TolyIcon.icon_show : TolyIcon.icon_hide))
                ],
              ),
              Row(
                children: <Widget>[
                  ...
                  Text(
                    "自动登录",
                    style: TextStyle(color: const Color(0xff444444), fontSize: 30.sp),
                  ),
                  Spacer(),
                  GestureDetector(
                      onTap: () {
  ...
  Widget _buildBtn(BuildContext context) => Container(
    ...
    child: RaisedButton(
      ...
      onPressed: (){
        ...
        logic.login(logic.usernameController.text,logic.passwordController.text);
      },
      child: Text("登   录",
...
class ArcBackground extends StatelessWidget {
  ...
  const ArcBackground({Key? key, required  this.child, required this.image}) : super(key: key);
